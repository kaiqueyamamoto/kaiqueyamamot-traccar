                            ...
                            @foreach ($item['table']['rows'] as $row)
                                ...
                                <tr style="background-color: {{ $backgroundColor }}; color: #000000;">
                                    @if ($report->getFormat() == 'xls')
                                        ...
                                        <td style="{{ $xlsStyle }}">{{ $row['ht'] }}</td>
                                        <td style="{{ $xlsStyle }}">=I{{ $line }}/B{{ $line }}*100</td>
                                        <td style="{{ $xlsStyle }}">=D{{ $line }}+F{{ $line }}+H{{ $line }}+J{{ $line }}</td>
                                    @else
                                        ...
                                        <td style="text-align: center;">{{ $row['ht'] }}</td>
                                        <td style="text-align: center;">{{ $row['score_harsh_t'] }}</td>
        ...
        <div class="panel panel-default">
            <div class="panel-body no-padding" style="padding: 0px;">
                <table class="table" style="table-layout: auto; margin-bottom: 0px;">
                    ...
                    <tr>
                        <td style="width: 150px;">R = OS + AS + BS + TS</td>
                        <td>RAG</td>
                    </tr>
                    </tbody>
                </table>
