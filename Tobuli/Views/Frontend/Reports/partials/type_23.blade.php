                    ...
                    <div class="panel-body no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{ trans('front.seatbelt_off_duration') }}</th>
                                <th>{{ trans('front.seatbelt_off_score') }}</th>
                                <th>RAG</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($item['table']['rows'] as $row)
                                ...
                                <tr style="background-color: {{ $backgroundColor }}; color: #000000;">
                                    @if ($report->getFormat() == 'xls')
                                        ...
                                        <td style="{{ $xlsStyle }}">{{ $row['speed_max'] }}</td>
                                        <td style="{{ $xlsStyle }}">{{ $row['duration'] }}</td>
                                        <td style="{{ $xlsStyle }}">=D{{ $line }}/10/B{{ $line }}*100</td>
                                        <td style="{{ $xlsStyle }}">{{ $row['ha'] }}</td>
                                        <td style="{{ $xlsStyle }}">=F{{ $line }}/B{{ $line }}*100</td>
                                        <td style="{{ $xlsStyle }}">{{ $row['hb'] }}</td>
                                        <td style="{{ $xlsStyle }}">=H{{ $line }}/B{{ $line }}*100</td>
                                        <td style="{{ $xlsStyle }}">{{ $row['sb'] }}</td>
                                        <td style="{{ $xlsStyle }}">=J{{ $line }}/10/B{{ $line }}*100</td>
                                        <td style="{{ $xlsStyle }}">=E{{ $line }}+G{{ $line }}+I{{ $line }}+K{{ $line }}</td>
                                    @else
                                        <td style="text-align: center;">{{ $row['drivers'] }}</td>
                                        <td style="text-align: center;">{{ $row['distance'] }}</td>
                                        <td style="text-align: center;">{{ $row['speed_max'] }}</td>
                                        ...
                                        <td style="text-align: center;">{{ $row['sb'] }}</td>
                                        <td style="text-align: center;">{{ $row['score_seatbelt'] }}</td>
    ...
    <div class="panel panel-default">
        <div class="panel-body no-padding">
            <table class="table " style="color: #000000;">
                <tbody>
                <tr>
                    <td style="background-color: #FF0000;">{{ strtoupper(trans('front.above')) }} 3</td>
                </tr>
                <tr>
                    <td style="background-color: #FFFF00;">{{ strtoupper(trans('front.between')) }} 1 {{ strtoupper(trans('front.and')) }} 3</td>
                </tr>
                <tr>
                    <td style="background-color: #00d400;">{{ strtoupper(trans('front.less_than')) }} 1</td>
                </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="panel-body no-padding" style="padding: 0px;">
                <table class="table" style="table-layout: auto; margin-bottom: 0px;">
                    ...
                    <tr>
                        ...
                        <td>{{ trans('front.seatblet_off_duration') }}</td>
                    </tr>
                    <tr>
                        <td style="width: 150px;">SS = SD / 10 / D * 100</td>
                        <td>{{ trans('front.seatblet_off_score') }}</td>
                    </tr>
                    <tr>
